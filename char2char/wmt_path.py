...
pipw = {
    "dic": [
        ["pipw/train/all_pi-pw.pi.tok.300.pkl",
         "pipw/train/all_pi-pw.pw.tok.300.pkl", ],

        ["pipw/train/all_pi-pw.pi.tok.bpe.word.pkl"],
    ],

    "train": [
        ["pipw/train/all_pi-pw.pi.tok.shuf",
         "pipw/train/all_pi-pw.pw.tok.shuf", ],

        ["pipw/train/all_pi-pw.pi.tok.bpe.shuf",
         "pipw/train/all_pi-pw.pw.tok.bpe.shuf", ],
    ],

    "dev": [
        ["pipw/dev/all_pi-pw.pi.tok.shuf",
         "pipw/dev/all_pi-pw.pw.tok.shuf", ],

        ["pipw/dev/all_pi-pw.pi.tok.bpe.shuf",
         "pipw/dev/all_pi-pw.pw.tok.bpe.shuf", ],
    ],

    "test1": [
        ["pipw/test/all_pi-pw.pi.tok.shuf",
         "pipw/test/all_pi-pw.pw.tok.shuf", ],

        ["pipw/test/all_pi-pw.pi.tok.bpe.shuf",
         "pipw/test/all_pi-pw.pw.tok.bpe.shuf", ],
    ],
}
"""
